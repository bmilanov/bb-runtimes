...
--  which use a mix of Thumb1 and Thumb2 instructions.
...
package body System.BB.CPU_Primitives is
   ...
   --  As ARMv6M does not directly provide a single-shot alarm timer, and
   ...
   --  This port uses the ARMv6-M hardware for saving volatile context for
   ...
   SHPR2 : Word with Volatile, Address => 16#E000_ED1C#; -- Sys Hand    11 Prio
   SHPR3 : Word with Volatile, Address => 16#E000_ED20#; -- Sys Hand 14-15 Prio
   ...
   begin
      ...
      Asm
        (Template =>
         ...
         "str  r3, [r2]"                & NL & -- Update value of Pend_SV_Cont
         "ldm  r3, {r4-r7}"             & NL & -- Load context and new PSP
         "ldm  r3, {r1}"                & NL &
         "mov  r8, r1"                  & NL &
         "ldm  r3, {r1}"                & NL &
         "mov  r9, r1"                  & NL &
