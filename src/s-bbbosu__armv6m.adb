...
package body System.BB.Board_Support is
   ...
   NVIC_ISER : constant Address := NVIC_Base + 16#100#;
   ...
   --  setting is such that the 2 most significant bits determine the priority
   ...
   begin
      if Interrupt = Alarm_Interrupt_ID then
         ...
         declare
            ...
            NVIC_ISER0 : array (0 .. 15) of Word
                           with Volatile, Address => NVIC_ISER;
