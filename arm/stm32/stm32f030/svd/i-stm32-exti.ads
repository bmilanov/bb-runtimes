...
package Interfaces.STM32.EXTI is
   ...
   subtype RTSR_TR19_Field is Interfaces.STM32.Bit;
   ...
   subtype FTSR_TR19_Field is Interfaces.STM32.Bit;
   ...
   subtype SWIER_SWIER19_Field is Interfaces.STM32.Bit;
   ...
   subtype PR_PR19_Field is Interfaces.STM32.Bit;
