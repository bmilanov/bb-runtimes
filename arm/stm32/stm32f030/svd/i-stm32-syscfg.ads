...
package Interfaces.STM32.SYSCFG is
   ...
   subtype CFGR1_MEM_MODE_Field is Interfaces.STM32.UInt2;
   subtype CFGR1_ADC_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_USART1_TX_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_USART1_RX_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM16_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM17_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C_PB6_FM_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C_PB7_FM_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C_PB8_FM_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C_PB9_FM_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C1_FM_plus_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C2_FM_plus_Field is Interfaces.STM32.Bit;
   subtype CFGR1_SPI2_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_USART2_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_USART3_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C1_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM1_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM2_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM3_DMA_RMP_Field is Interfaces.STM32.Bit;
   ...
   subtype CFGR2_LOCUP_LOCK_Field is Interfaces.STM32.Bit;
   subtype CFGR2_SRAM_PARITY_LOCK_Field is Interfaces.STM32.Bit;
   subtype CFGR2_PVD_LOCK_Field is Interfaces.STM32.Bit;
   subtype CFGR2_SRAM_PEF_Field is Interfaces.STM32.Bit;
