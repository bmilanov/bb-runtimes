...
package Interfaces.STM32.ADC is
   ...
   subtype ISR_AWD_Field is Interfaces.STM32.Bit;
   ...
   subtype IER_AWDIE_Field is Interfaces.STM32.Bit;
   ...
   type CR_Register is record
      ...
      --  unspecified
      Reserved_5_30 : Interfaces.STM32.UInt26 := 16#0#;
      --  ADC calibration
   ...
   subtype CFGR1_DMAEN_Field is Interfaces.STM32.Bit;
   subtype CFGR1_DMACFG_Field is Interfaces.STM32.Bit;
   subtype CFGR1_SCANDIR_Field is Interfaces.STM32.Bit;
   subtype CFGR1_RES_Field is Interfaces.STM32.UInt2;
   subtype CFGR1_ALIGN_Field is Interfaces.STM32.Bit;
   subtype CFGR1_EXTSEL_Field is Interfaces.STM32.UInt3;
   subtype CFGR1_EXTEN_Field is Interfaces.STM32.UInt2;
   subtype CFGR1_OVRMOD_Field is Interfaces.STM32.Bit;
   subtype CFGR1_CONT_Field is Interfaces.STM32.Bit;
   subtype CFGR1_AUTDLY_Field is Interfaces.STM32.Bit;
   subtype CFGR1_AUTOFF_Field is Interfaces.STM32.Bit;
   subtype CFGR1_DISCEN_Field is Interfaces.STM32.Bit;
   subtype CFGR1_AWDSGL_Field is Interfaces.STM32.Bit;
   subtype CFGR1_AWDEN_Field is Interfaces.STM32.Bit;
   subtype CFGR1_AWDCH_Field is Interfaces.STM32.UInt5;
   ...
   subtype CFGR2_JITOFF_D_Element is Interfaces.STM32.Bit;
   ...
   type CFGR2_Register is record
      --  unspecified
      Reserved_0_29 : Interfaces.STM32.UInt30 := 16#8000#;
      --  JITOFF_D2
   ...
   subtype SMPR_SMPR_Field is Interfaces.STM32.UInt3;
   ...
   subtype TR_LT_Field is Interfaces.STM32.UInt12;
   subtype TR_HT_Field is Interfaces.STM32.UInt12;
   ...
   subtype CHSELR_CHSEL_Element is Interfaces.STM32.Bit;
   ...
   subtype CCR_TSEN_Field is Interfaces.STM32.Bit;
   subtype CCR_VBATEN_Field is Interfaces.STM32.Bit;
